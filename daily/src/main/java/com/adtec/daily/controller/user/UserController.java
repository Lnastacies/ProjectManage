...
public class UserController {
    ...
    @ResponseBody
    public Msg getUserWithJson(@RequestParam(value = "pn", defaultValue = "1") Integer pn,@RequestParam(value = "roleType") String roleType) {

        PageHelper.startPage(pn, 5);
        List<User> pros = userService.getAll(roleType);
    ...
    @ResponseBody
    public Msg getUserInfoByUserName(@RequestParam(value = "pn", defaultValue = "1") Integer pn, @RequestParam String userName) {

        PageHelper.startPage(pn, 5);
        List<User> pros = userService.getUserInfoByUserName(userName);
        PageInfo page = new PageInfo(pros, 5);
        return Msg.success().add("pageInfo", page);
    }

                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="dailyPercent" class="form-control" id="dailyPercent_add_input">
                                <span class="help-block"></span>
                            </div>
                            ...
                            <div class="col-sm-5">
                                <select name="execution" class="form-control">
                                    ...
                                    <option value="01" selected="">未开始</option>
                                    <option value="02">正在进行</option>
...
<script type="text/javascript">
    ...
    function to_page(pn) {
        ...
        $.ajax({
            url: "${APP_PATH}/getDailyDetailList",
            data: params,
            type: "POST",
